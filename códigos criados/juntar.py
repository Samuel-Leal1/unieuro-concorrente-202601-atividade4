...
juntar.py
---------
Junta as partes processadas da pasta 'partes_cinza/'
em uma única imagem PPM final.

Uso:
    python juntar.py imagem_saida.ppm
    python juntar.py imagem_saida.ppm --pasta partes_cinza
"""
